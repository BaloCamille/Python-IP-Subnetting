#import the NetworkingUtilities file to get the necessary functions and classes
...
def main():
    ...
    #display stats:
    print("Summary")
    print(f"\tThere are {len(netIDs)} unique networks")
    print(f"\tThere are {len(totalIPs)} IP addresses")
